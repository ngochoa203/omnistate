...
pub fn move_mouse(point: Point) -> OmniResult<()> {
    ...
    #[cfg(target_os = "ios")]
    return ios::move_mouse(point);
    #[cfg(target_os = "android")]
    return android::move_mouse(point);
}
...
pub fn click(button: MouseButton) -> OmniResult<()> {
    ...
    #[cfg(target_os = "ios")]
    return ios::click(button);
    #[cfg(target_os = "android")]
    return android::click(button);
}
...
pub fn double_click(button: MouseButton) -> OmniResult<()> {
    ...
    #[cfg(target_os = "ios")]
    return ios::double_click(button);
    #[cfg(target_os = "android")]
    return android::double_click(button);
}
...
pub fn scroll(dx: i32, dy: i32) -> OmniResult<()> {
    ...
    #[cfg(target_os = "ios")]
    return ios::scroll(dx, dy);
    #[cfg(target_os = "android")]
    return android::scroll(dx, dy);
}
...
pub fn type_text(text: &str) -> OmniResult<()> {
    ...
    #[cfg(target_os = "ios")]
    return ios::type_text(text);
    #[cfg(target_os = "android")]
    return android::type_text(text);
}
...
pub fn move_mouse_smooth(from: Point, to: Point, steps: u32) -> OmniResult<()> {
    ...
    #[cfg(target_os = "ios")]
    return ios::move_mouse_smooth(from, to, steps);
    #[cfg(target_os = "android")]
    return android::move_mouse_smooth(from, to, steps);
}
...
pub fn drag(from: Point, to: Point) -> OmniResult<()> {
    ...
    #[cfg(target_os = "ios")]
    return ios::drag(from, to);
    #[cfg(target_os = "android")]
    return android::drag(from, to);
}
